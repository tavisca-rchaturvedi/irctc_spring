...
public class AdminController {
    ...
    public void addTrain(@RequestBody Train train1){
        ...
        List<Stop> stops =new ArrayList<Stop>(){{
            new Stop(Instant.now(), Instant.now(), 200, new HashMap<BerthType, Integer>(){{put(BerthType.SECOND_AC, 5);}}, pune);
            new Stop(Instant.now(), Instant.now(), 200, new HashMap<BerthType, Integer>(){{put(BerthType.FIRST_AC, 5);}}, mumbai);
        }};
